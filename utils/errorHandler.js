...
class ErrorHandler {
    ...
    getUserFriendlyMessage(category) {
        const messages = {
            ...
            'PERMISSION': '🚫 Akses ditolak atau IP terblokir. Coba lagi nanti.',
    ...
    sanitizeErrorMessage(message) {
        ...
        // Remove HTML tags and long HTML responses (Cloudflare blocks, etc)
        if (message.includes('<!DOCTYPE') || message.includes('<html')) {
            return 'API Server Error (Cloudflare blocked)';
        }
